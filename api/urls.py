...
urlpatterns = [
    ...
    path('media-list', csrf_exempt(views.get_media_list), name='get_media_list'),
    path('watch-list', csrf_exempt(views.WatchList.as_view()), {'list_id': None},
         name='watch-list'),
    path('watch-list/<int:list_id>', csrf_exempt(views.WatchList.as_view()), name='watch-list'),
    # Items
    path('watch-list/<int:list_id>/items', csrf_exempt(views.WatchlistItem.as_view()),
         name='watch-list-items',),
]
